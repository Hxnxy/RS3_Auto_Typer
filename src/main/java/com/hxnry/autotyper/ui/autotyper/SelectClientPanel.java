...
public class SelectClientPanel extends JPanel {
    ...
    public SelectClientPanel(Dialog dialog) {
        this.dialog = dialog;
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(row == -1) return;
                String selection = table.getValueAt(row, 1).toString();
                if(selection == null) return;
                pid = Integer.parseInt(selection);
                dialog.dispose();
            }
        });
    ...
    private void refreshTable() {
        ...
        User32.INSTANCE.EnumWindows((hWnd, data) -> {
            ...
            if (windowStartsWith(title, "rs3 -", "runescape")) {
                User32.INSTANCE.EnumChildWindows(hWnd, (child, pointer) -> {
                    ...
                    User32.INSTANCE.GetClassName(child, innerClass, 512);
