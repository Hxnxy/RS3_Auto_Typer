...
public class ConfigurationProfileManager  {
    ...
    public static void createProfile(ConfigurationProfile profile) {
    ...
    public static void saveJson(ConfigurationProfile profile ){
    ...
    public static void saveTimerJson(ConfigurationProfile profile ){
        try (Writer writer = new FileWriter(getSavePath()  + profile.name + ".json")) {
            Gson gson = new GsonBuilder().setPrettyPrinting().create();
            gson.toJson(profile, writer);
        } catch (IOException e) {
    ...
    public static ConfigurationProfile loadProfile(Type type, String fileName){
    ...
    public static ConfigurationProfile loadProfile(String fileName){
        try (Reader reader = new FileReader(getSavePath()  + fileName)) {
    ...
    private static final Type PROFILE_TYPE = new TypeToken<ConfigurationProfile>() {
    }.getType();
    ...
    public static ConfigurationProfile getProfileByName(String name) {
        String savePath = getSavePath();
