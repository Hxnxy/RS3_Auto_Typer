...
public class JhromeTabBorderAttributes
{
	...
	static
	{
		...
		UNSELECTED_BORDER.topColor = UNSELECTED_BORDER.bottomColor = new Color(107, 97, 94);
		UNSELECTED_BORDER.outlineColor = new Color( 70, 63, 71);
	...
	public Color outlineColor		= new Color(105, 86, 83);

	public Color topColor			= new Color(56, 54, 46);
	//public Color topColor			= new Color(81, 81, 81);
	//public Color bottomColor			= new Color(97, 97, 97);
	public Color bottomColor			= new Color(107, 97, 94);
